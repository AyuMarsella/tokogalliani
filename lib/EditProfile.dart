          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: TextField(
                  controller: TextEditingController(text: "Ayu"),
                  obscureText: false,
                  textAlign: TextAlign.start,
                  maxLines: 1,
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(0, 16, 0, 0),
                child: TextField(
                  controller: TextEditingController(text: "Sella"),
                  obscureText: false,
                  textAlign: TextAlign.start,
                  maxLines: 1,
                  style: const TextStyle(
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(0, 16, 0, 0),
                child: TextField(
                  controller: TextEditingController(text: "Ayu Sella"),
                  obscureText: false,
                  textAlign: TextAlign.start,
                  maxLines: 1,
                  style: const TextStyle(
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(0, 16, 0, 0),
                child: TextField(
                  controller: TextEditingController(text: "0800-0000-0000"),
                  obscureText: false,
                  textAlign: TextAlign.start,
                  maxLines: 1,
                  style: const TextStyle(
              ...
              Padding(
                ...
                child: TextField(
                  controller:
                      TextEditingController(text: "sella.ayu2016@gmail.com"),
                  obscureText: false,
                  textAlign: TextAlign.start,
                  maxLines: 1,
                  style: const TextStyle(
